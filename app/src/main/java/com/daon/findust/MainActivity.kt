...
import com.daon.findust.databinding.ActivityMainBinding
import com.daon.findust.retrofit.AirQualityResponse
import com.daon.findust.retrofit.AirQualityService
import com.daon.findust.retrofit.RetrofitConnection
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getAirQualityData(latitude: Double, longitude: Double) { // 레트로핏 객체를 이용하면 AirQualityService 인터페이스 구현체를 가져올 수 있습니다.
        ...
        retrofitAPI.getAirQualityData(
            latitude.toString(), longitude.toString(), "2f5c3af1-146f-4450-a9fc-6a9ced650ba3"
